...
PRICE_TEXT = """# <a:nichooo:1515711803844202627> **Bảng Giá Nicho Boost**
##   Nicho boost log
| • ***1 Tháng*** - ` 90.000 `
| • ***2 Tháng*** - ` 99.000 `
| • ***1 Năm*** - ` 850.000 `
| • ***Gia hạn 2 Tháng*** - ` 95.000 `
- Nếu bạn đã mua **Nicho Boost** bên mình thì có thể gia hạn lại tiếp 2 tháng với giá chỉ 95.000.
- Vui lòng chuẩn bị *tài khoản, mật khẩu, t0ken* 
## Nicho boost [Trail] log
| • ***1 Tháng*** - ` 40.000 `
| • ***3 Tháng*** - ` 70.000 `
| • ***4 Tháng*** - ` 90.000 ` (Không bảo hành tháng thứ 4)
Dạng link promo không nhận claim
| • ***Link promo 1 Tháng*** - ` 29.000 `
| • ***Link promo 3 Tháng*** - ` 59.000 `
- Dành cho tài khoản nào chưa xài **Nicho Boost** lần nào và phải trên 1 tháng.
- Vui lòng chuẩn bị *tài khoản, mật khẩu, t0ken* 
