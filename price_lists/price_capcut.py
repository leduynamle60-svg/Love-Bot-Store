...
CHANNEL_ID    = 1515676037520818367
THUMBNAIL_URL = "https://cdn.discordapp.com/emojis/1525025151001956372.webp?size=128"                   # URL ảnh thumbnail (để trống nếu không có)

# ─────────────────────────────────────────────────────────────

PRICE_TEXT = """# <:capcut:1525025151001956372> **Bảng Giá Capcut**
##   Capcut cấp acc
| • ***7 Ngày***  - ` 25.000 `
| • ***1 Tháng*** - ` 75.000`
- Sốp sẽ gửi tk,mk cho bạn
...
async def on_ready():
    ...
    print(f"✅ Đã gửi bảng giá Capcut vào #{channel.name}")
    await bot.close()
